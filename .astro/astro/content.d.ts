...
"java-tutorial-series/java-tutorial-part-11.md": {
	id: "java-tutorial-series/java-tutorial-part-11.md";
  slug: "java-tutorial-series/java-tutorial-part-11";
  body: string;
  collection: "tutorials";
  data: InferEntrySchema<"tutorials">
} & { render(): Render[".md"] };
"java-tutorial-series/java-tutorial-part-15.md": {
	id: "java-tutorial-series/java-tutorial-part-15.md";
  slug: "java-tutorial-series/java-tutorial-part-15";
  body: string;
  collection: "tutorials";
  data: InferEntrySchema<"tutorials">
} & { render(): Render[".md"] };
